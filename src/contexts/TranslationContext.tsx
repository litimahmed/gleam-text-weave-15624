...
const translations: Translations = {
  ...
  'aboutPage.title': { en: 'About Toorrii', fr: 'À propos de Toorrii', ar: 'عن توريي' },
  ...
  'privacyPage.title': { en: 'Privacy & Policy', fr: 'Confidentialité et Politique', ar: 'الخصوصية والسياسة' },
